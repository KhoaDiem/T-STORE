            ...
            <div className="product_desc_info">
              <div className="product-review">
                <h5 className="manufacturer">
                  <Link to={`/categories/${product.categoryId}`} style={{
                    marginLeft: 8
                  }} >
                ...
                <div className="rating-box" style={{ marginRight: 20 }}>
                  <ul className="rating">
                    <BeautyStars
                      size={10}
                      activeColor={"#ed8a19"}
              ...
              <div className="price-box">
                <span className="new-price new-price-2"style={{
                    marginLeft: 8
                  }} >
