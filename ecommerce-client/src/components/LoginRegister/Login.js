...
class Login extends Component {
  ...
  render() {
    ...
    return (
      <div className="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30 login">
        {" "}
        {/* Login Form s*/}{" "}
          ...
          <div className="login-form">
            ...
            <div className="row">
              ...
              <div className="col-md-4 mt-10 mb-20 text-left text-md-right">
                <Link to="/forgot-password"style={{marginRight:10}} > Forgotten pasward ? </Link>{" "}
              </div>{" "}
              <div className="col-md-4">
                <button className="register-button mt-0 mb-3"> Login </button>{" "}
              </div>{" "}
              <div>
                <Link to="/sign-up" style={{marginLeft:30}}> Create Your Account </Link>{" "}
              </div>{" "}
              <div className="col-md-8 capcha">
                <Recaptcha
